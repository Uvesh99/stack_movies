...
//   const [isEditing, setIsEditing] = useState(false);
//   const userType = localStorage.getItem("userType") || "";
//   const adminId = localStorage.getItem("adminId") || ""; // Assuming user ID is stored in local storage
//   const navigate = useNavigate();
...
//   const handleDeleteClick = (movie, e) => {
//     e.stopPropagation();
//     if (movie.admin._id === adminId) {
//       handleDeleteMovie(movie._id, e);
//     } else {
//       alert('You are not authorized to delete this movie.');
//     }
//   };
...
//                   <>
//                     <Button variant="contained" color="primary" onClick={(e) => handleEditClick(movie, e)}>Edit</Button>
//                     <Button variant="contained" color="error" onClick={(e) => handleDeleteClick(movie, e)} sx={{ ml: 1 }}>Delete</Button>
//                   </>
//                 )}
//               </CardContent>
//             </Card>
