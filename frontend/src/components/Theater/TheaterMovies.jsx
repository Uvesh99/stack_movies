...
function TheaterMovies() {
  ...
  return (
    <Box p={2}>
      <Typography variant="h4" color="white" gutterBottom textAlign={'center'} marginBottom={'3rem'}>
        Available Movies
      </Typography>
      <Grid container spacing={2}>
        {movies.map(movie => (
            ...
            >
              ...
              <CardContent>
                ...
                {userType === 'Admin' && movie.admin === adminId && (
                  <>
                    <Button variant="contained" color="primary" onClick={(e) => handleEditClick(movie, e)}>
                      Edit
                    </Button>
                    <Button variant="contained" color="error" onClick={(e) => handleDeleteMovie(movie._id, e)} sx={{ ml: 1 }}>
                      Delete
                    </Button>
                  </>
                )}
